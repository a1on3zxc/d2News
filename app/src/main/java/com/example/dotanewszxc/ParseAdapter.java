...
public class ParseAdapter extends RecyclerView.Adapter<ParseAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ParseAdapter.ViewHolder holder, int position) {
        ...
        holder.dataTextView.setText(parseItem.getDataTime());
        holder.starTextView.setText(parseItem.getStar());
        if (parseItems != null && parseItems.isEmpty()) {
            holder.imageView.setImageResource(R.drawable.dota);
        } else
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            dataTextView = itemView.findViewById(R.id.data_time_text_view);
